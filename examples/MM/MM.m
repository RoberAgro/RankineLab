...
T_0 = 20+273.15;                                                           % Ambient temperature

% Define the working fluids
heating_fluid = 'HEOS::Air';
working_fluid = 'HEOS::MM';
...
T_1 = 300+273.15;                                                          % Heat source inlet temperature (K)
p_1 = p_0;                                                                 % Heat source inlet pressure (Pa)
p_3 = p_0;                                                                 % Heat source outlet pressure (Pa)
T_3min = 120+273.15;                                                        % Minimum temperature at the outlet of the heat source (K)
...
eta_expander = 0.88;                                                       % Efficiency of the expander
...
x5 = (1.5*p_crit-p_min)/(p_max-p_min);
x5_min = 0.00;
x5_max = 1.00;
