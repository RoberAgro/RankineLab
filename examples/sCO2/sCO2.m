...
T_0 = 30+273.15;                                                           % Ambient temperature

% Define the working fluids
heating_fluid = 'HEOS::Air';
working_fluid = 'HEOS::CO2';
...
T_1 = 400+273.15;                                                          % Heat source inlet temperature (K)
p_1 = p_0;                                                                 % Heat source inlet pressure (Pa)
p_3 = p_0;                                                                 % Heat source outlet pressure (Pa)
T_3min = 50+273.15;                                                        % Minimum temperature at the outlet of the heat source (K)
...
dp_h_rec  = 0.02;                                                          % Pressure drop in the hot side of the recuperator (relative with respect to inlet)
dp_c_rec  = 0.02;                                                          % Pressure drop in the cold side of the recuperator (relative with respect to inlet)
...
eta_pump_h = 0.85;                                                         % Isentropic efficiency of the heat source pump
eta_pump_f = 0.85;                                                         % Isentropic efficiency of the working fluid pump
eta_pump_c = 0.85;                                                         % Isentropic efficiency of the heat sink pump

% Define the efficiency of the expander
eta_expander = 0.90;                                                       % Efficiency of the expander
...
p_max = 5.00*p_crit;                                                       % Maximum pressure
...
x3 = (2.0*p_sat0-p_min)/(p_max-p_min);
x3_min = 0.00;
x3_max = 1.00;
...
x5 = (3.00*p_crit-p_min)/(p_max-p_min);
x5_min = 0.00;
x5_max = 1.00;
...
constraints.dT_subcooling.apply = 'no';
...
constraints.dT_superheating.apply = 'no';

% Maximum cycle pressure
constraints.pressure.min = [];
constraints.pressure.max = 300e5;
constraints.pressure.apply = 'no';
